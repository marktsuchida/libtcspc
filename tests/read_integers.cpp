...
TEST_CASE("Read u16np impl") {
    ...
    SECTION("Zero") {
        data = {0, 0};
        REQUIRE(internal::read_u16le(std::as_bytes(std::span(data))) ==
                0_u16np);
    }
...
TEST_CASE("Read u32np impl") {
    ...
    SECTION("Zero") {
        REQUIRE(internal::read_u32le(std::as_bytes(std::span(data))) ==
                0_u32np);
    }
...
TEST_CASE("Read u64np impl") {
    ...
    SECTION("Zero") {
        REQUIRE(internal::read_u64le(std::as_bytes(std::span(data))) ==
                0_u64np);
    }
