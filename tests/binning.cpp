...
TEST_CASE("Linear bin mapping") {
    ...
    linear_bin_mapper<data_traits> const m010(
        arg_offset{0}, arg_bin_width{1}, arg_max_bin_index<u16>{0}, clamp);
    REQUIRE(m010.n_bins() == 1);
    REQUIRE(check_clamped(m010(-1), 0));
    REQUIRE(m010(0).value() == 0);
    REQUIRE(check_clamped(m010(1), 0));

    linear_bin_mapper<data_traits> const m110(
        arg_offset{1}, arg_bin_width{1}, arg_max_bin_index<u16>{0}, clamp);
    REQUIRE(m110.n_bins() == 1);
    REQUIRE(check_clamped(m110(0), 0));
    REQUIRE(m110(1).value() == 0);
    REQUIRE(check_clamped(m110(2), 0));

    linear_bin_mapper<data_traits> const nn10(
        arg_offset{-1}, arg_bin_width{1}, arg_max_bin_index<u16>{0}, clamp);
    ...
    linear_bin_mapper<data_traits> const m020(
        arg_offset{0}, arg_bin_width{2}, arg_max_bin_index<u16>{0}, clamp);
    ...
    linear_bin_mapper<data_traits> const m120(
        arg_offset{1}, arg_bin_width{2}, arg_max_bin_index<u16>{0}, clamp);
    ...
    linear_bin_mapper<data_traits> const mn20(
        arg_offset{-1}, arg_bin_width{2}, arg_max_bin_index<u16>{0}, clamp);
    ...
    linear_bin_mapper<data_traits> const m0n0(
        arg_offset{0}, arg_bin_width{-1}, arg_max_bin_index<u16>{0}, clamp);
    ...
    linear_bin_mapper<data_traits> const m1n0(
        arg_offset{1}, arg_bin_width{-1}, arg_max_bin_index<u16>{0}, clamp);
    ...
    linear_bin_mapper<data_traits> const mnn0(
        arg_offset{-1}, arg_bin_width{-1}, arg_max_bin_index<u16>{0}, clamp);
    ...
    linear_bin_mapper<data_traits> const m011(
        arg_offset{0}, arg_bin_width{1}, arg_max_bin_index<u16>{1}, clamp);
    ...
    linear_bin_mapper<data_traits> const m111(
        arg_offset{1}, arg_bin_width{1}, arg_max_bin_index<u16>{1}, clamp);
    ...
    linear_bin_mapper<data_traits> const mn11(
        arg_offset{-1}, arg_bin_width{1}, arg_max_bin_index<u16>{1}, clamp);
    ...
    linear_bin_mapper<data_traits> const m0n1(
        arg_offset{0}, arg_bin_width{-1}, arg_max_bin_index<u16>{1}, clamp);
    ...
    linear_bin_mapper<data_traits> const m1n1(
        arg_offset{1}, arg_bin_width{-1}, arg_max_bin_index<u16>{1}, clamp);
    ...
    linear_bin_mapper<data_traits> const mnn1(
        arg_offset{-1}, arg_bin_width{-1}, arg_max_bin_index<u16>{1}, clamp);
    ...
    linear_bin_mapper<data_traits> const maxint(
        arg_offset{0}, arg_bin_width{32768}, arg_max_bin_index<u16>{65535},
        clamp);
    ...
    linear_bin_mapper<data_traits_u32> const maxuint(
        arg_offset{0u}, arg_bin_width{65536u}, arg_max_bin_index<u16>{65535},
        clamp);
    ...
    linear_bin_mapper<data_traits> const flipped(
        arg_offset{4095}, arg_bin_width{-16}, arg_max_bin_index<u16>{255},
        clamp);
